...
from worldbrain.cortex.models import AllUrl, Source, SourceStates
...
parameters = pika.ConnectionParameters('polisky.me', 5672, '/worldbrain',
                                       credentials)  # TODO use another server for RabbitMQ
rabbitmq_connection = pika.adapters.blocking_connection.BlockingConnection(parameters)
